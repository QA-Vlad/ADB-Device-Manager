 ...
 */
object FileLogger {
    private const val LOG_DIR_NAME = "AdbRandomizerLogs"
    private const val LOG_FILE_PREFIX = "adb_randomizer_"
    ...
    private fun initializeLogger() {
        try {
            ...
            println("ADB_RANDOMIZER: Failed to initialize file logger: ${e.message}")
        }
    }
    ...
    fun log(message: String, level: String = "INFO") {
        ...
        lock.withLock {
            try {
                ...
                println("ADB_RANDOMIZER: Failed to write to log file: ${e.message}")
            }
        }
    }
    ...
    private fun rotateLog() {
        try {
            ...
            println("ADB_RANDOMIZER: Failed to rotate log: ${e.message}")
        }
    }
