...
import io.github.qavlad.adbdevicemanager.ui.config.DeviceType
import io.github.qavlad.adbdevicemanager.ui.config.HitboxConfigManager
import io.github.qavlad.adbdevicemanager.ui.config.HitboxType
import io.github.qavlad.adbdevicemanager.ui.dialogs.AdbConfigurationDialog
import io.github.qavlad.adbdevicemanager.ui.models.CombinedDeviceInfo
import io.github.qavlad.adbdevicemanager.ui.renderers.DeviceListRenderer
import io.github.qavlad.adbdevicemanager.utils.AdbPathResolver
import io.github.qavlad.adbdevicemanager.utils.DeviceConnectionUtils
...
class DeviceListPanel(
    ...
    private val combinedDeviceRenderer = io.github.qavlad.adbdevicemanager.ui.renderers.CombinedDeviceRenderer(
    ...
    private fun setupDeviceListInteractions() {
        ...
        deviceList.addMouseListener(object : MouseAdapter() {
            ...
            override fun mouseExited(event: MouseEvent?) {
                ...
                resetHoverState()
                if (PluginSettings.instance.debugHitboxes) {
                    io.github.qavlad.adbdevicemanager.ui.renderers.CombinedDeviceRenderer.debugMousePosition = null
                    io.github.qavlad.adbdevicemanager.ui.renderers.CombinedDeviceRenderer.debugHoveredIndex = -1
                    deviceList.repaint()
                }
            }
        })
        ...
        if (PluginSettings.instance.debugHitboxes) {
            ...
            if (index != -1 && index < deviceListModel.size()) {
                ...
                if (bounds != null) {
                    ...
                    io.github.qavlad.adbdevicemanager.ui.renderers.CombinedDeviceRenderer.debugMousePosition =
                        Point(e.point.x - bounds.x, e.point.y - bounds.y)
                    io.github.qavlad.adbdevicemanager.ui.renderers.CombinedDeviceRenderer.debugHoveredIndex = index
                }
            }
            deviceList.repaint()
        }
