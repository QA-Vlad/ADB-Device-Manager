...
import io.github.qavlad.adbdevicemanager.services.PresetApplicationService
...
class TableEventHandler(
    ...
    private val onPresetApplied: ((preset: io.github.qavlad.adbdevicemanager.services.DevicePreset, listName: String?, setSize: Boolean, setDpi: Boolean) -> Unit)? = null,
