package io.github.qavlad.adbdevicemanager.ui.handlers
    ...
    fun addGlobalKeyListener() {
        ...
        keyEventDispatcher = KeyEventDispatcher { e ->
            if (e.id == KeyEvent.KEY_PRESSED) {
                ...
                if (e.keyCode == KeyEvent.VK_LEFT && System.getProperty("adbdevicemanager.exportDialogOpen") == "true") {
                ...
                when {
                    ...
                    e.keyCode == KeyEvent.VK_LEFT || e.keyCode == KeyEvent.VK_RIGHT -> {
                        ...
                        if (System.getProperty("adbdevicemanager.exportDialogOpen") == "true") {
